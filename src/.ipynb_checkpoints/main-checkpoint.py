...
def infer(model, fnImg):
    ...
    print("\n\nThe Handwritten Script in the Image Recognized Without the Spelling Correction is: ", recognized[0])
    print("\nThe Recognized Handwritten script after the Correction is: ", correct_sentence(recognized[0]))
    return recognized[0]
